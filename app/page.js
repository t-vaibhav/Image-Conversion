    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"> Ease</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Professional image conversion, compression, and editing tools. Convert between formats, 
              reduce file sizes, and enhance your images with our powerful online tools.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                href="/Compressor"
                className="bg-white text-purple-600 border-2 border-purple-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-purple-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Compress Images
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Choose from our comprehensive suite of image processing tools designed for professionals and enthusiasts alike.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Converter Card */}
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Image Converter</h3>
              <p className="text-gray-600 mb-6">
                Convert images between popular formats like JPEG, PNG, GIF, WebP, and more. 
                Maintain quality while changing formats effortlessly.
              </p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Image Compressor</h3>
              <p className="text-gray-600 mb-6">
                Reduce image file sizes without losing quality. Perfect for web optimization, 
                email attachments, and storage space management.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Image Editor</h3>
              <p className="text-gray-600 mb-6">
                Edit and enhance your images with powerful tools. Crop, resize, adjust brightness, 
                and apply filters to create stunning visuals.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Professional-grade image processing tools designed with simplicity and power in mind.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Use directly in your browser, no downloads required</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Link 
            href="/Converter"
            className="bg-white text-purple-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-block"
          >
            Get Started Now
          </Link>
        </div>
